    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.menuContainer}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Schedule')} style={styles.menuItem1}>
          <Ionicons name="calendar" size={75} color="darkslategrey" />
          <Text style={styles.menuText}>Schedule</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('Patient')} style={styles.menuItem}>
          <Ionicons name="person" size={70} color="darkslategrey" />
          <Text style={styles.menuText}>Patient's{'\n'}Information</Text>
        </TouchableOpacity>
      </View>

      <Text style={styles.chartHeaderText1}>Monthly Acne Severity Trends</Text>
